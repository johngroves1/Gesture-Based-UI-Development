...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // If the player velocity is higher than the current score, increase the score
        ...
        // For pointing player sprite in the direction of the tilt mechanic
        ...
        // if the player transform is 50 less than the current score, GameOver
